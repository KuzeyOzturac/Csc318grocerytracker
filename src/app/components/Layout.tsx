...
import { Home, ClipboardList, Receipt, ShoppingCart, Coffee } from "lucide-react";
...
export const Layout = () => {
  ...
  const navItems = [
    ...
    { icon: Coffee, label: "Cooking", path: "/meals" },
  ];

  return (
    <div className="flex flex-col min-h-screen bg-gray-100" style={{ fontFamily: 'var(--font-sans)' }}>
